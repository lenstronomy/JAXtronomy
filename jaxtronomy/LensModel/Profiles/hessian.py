...
class Hessian(LensProfileBase):
    ...
    @staticmethod
    @jit
    def function(x, y, f_xx, f_yy, f_xy, f_yx, ra_0=0, dec_0=0):
        """
    ...
    @staticmethod
    @jit
    def derivatives(x, y, f_xx, f_yy, f_xy, f_yx, ra_0=0, dec_0=0):
        """
    ...
    @staticmethod
    @jit
    def hessian(x, y, f_xx, f_yy, f_xy, f_yx, ra_0=0, dec_0=0):
        """Hessian.
