...
class SinglePlaneGPU(ProfileListBase):
    ...
    def prepare_ray_shooting_kwargs(self, lens_model_list, kwargs_lens, num_deflectors=None):
    ...
    def ray_shooting(self, x, y, all_kwargs, index_list):
        """This function computes the ray tracing through all of the lens models given by index_list.
        The arguments all_kwargs and index_list should be obtained by calling SinglePlaneGPU.prepare_ray_shooting_kwargs().
