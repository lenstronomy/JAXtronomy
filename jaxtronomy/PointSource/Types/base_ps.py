...
class PSBase(object):
    ...
    def __init__(
        ...
        :param index_lens_model_list: list (length of different patches/bands) of integer lists, e.g., [[0, 1], [2, 3]];
            evaluating a subset of the lens models per individual bands. If None, then all lens models are assigned to all
            images.
        :param point_source_frame_list: list of ints, e.g. we can assign the i-th image to the second band
            with point_source_frame_list[i] = 2. Must be specified when index_lens_model_list is not None.
        ...
        # k_list is a list of tuples which combines index_lens_model_list with point_source_frame_list
