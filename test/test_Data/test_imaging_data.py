...
class Test_ImageData_noisemap(object):
    ...
    def test_log_likelihood(self):
        ...
        log_likelihood_ref = self.Data_ref.log_likelihood(model, mask, additional_error_map)
    ...
    def test_update_data(self):
        npt.assert_raises(Exception, self.Data.update_data, image_data=np.ones((self.numPix, self.numPix)))
...
class Test_ImageData_without_noisemap(object):
    def setup_method(self):
        ...
        self.Data = ImageData(**kwargs_data)
        self.Data_ref = ImageData_ref(**kwargs_data)
        self.Data_interferometry = ImageData(likelihood_method="interferometry_natwt", **kwargs_data)
        self.Data_interferometry_ref = ImageData_ref(likelihood_method="interferometry_natwt", **kwargs_data)
    ...
    def test_log_likelihood_interferometry(self):
        ...
        log_likelihood_ref = self.Data_interferometry_ref.log_likelihood(model, mask, additional_error_map)
