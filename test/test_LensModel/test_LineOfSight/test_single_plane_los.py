...
class TestSinglePlaneLOS(object):
    ...
    def test_los_versus_multiplane(self):
        ...
        beta_ra_los, beta_dec_los = lens_model_los.ray_shooting(theta_ra, theta_dec, kwargs_singleplane_los)

        fermat_pot_los = lens_model_los.fermat_potential(x_image=theta_ra, y_image=theta_dec,
                                                         x_source=beta_ra_los, y_source=beta_dec_los,
                                                         kwargs_lens=kwargs_singleplane_los)

        beta_ra_multiplane, beta_dec_multiplane = lens_model_multiplane.ray_shooting(theta_ra, theta_dec, kwargs_multiplane)

        fermat_pot_multiplane = lens_model_multiplane.fermat_potential(x_image=theta_ra, y_image=theta_dec,
                                                         x_source=beta_ra_multiplane, y_source=beta_dec_multiplane,
