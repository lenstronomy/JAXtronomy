...
class TestLOS(object):
    ...
    def test_distort_vector(self):
        ...
        x_distorted, y_distorted = self.LOS.distort_vector(x, y, kappa, gamma1, gamma2, omega)
        x_distorted_ref, y_distorted_ref = self.LOS_ref.distort_vector(x, y, kappa, gamma1, gamma2, omega)
    ...
    def test_left_multiply(self):
        ...
        f_xx, f_xy, f_yx, f_yy = self.LOS.left_multiply(fxx, fxy, fyx, fyy, kappa, gamma1, gamma2, omega)
        f_xx_ref, f_xy_ref, f_yx_ref, f_yy_ref = self.LOS_ref.left_multiply(fxx, fxy, fyx, fyy, kappa, gamma1, gamma2, omega)
    ...
    def test_right_multiply(self):
        ...
        f_xx, f_xy, f_yx, f_yy = self.LOS.right_multiply(fxx, fxy, fyx, fyy, kappa, gamma1, gamma2, omega)
        f_xx_ref, f_xy_ref, f_yx_ref, f_yy_ref = self.LOS_ref.right_multiply(fxx, fxy, fyx, fyy, kappa, gamma1, gamma2, omega)
