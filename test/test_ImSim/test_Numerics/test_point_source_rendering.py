...
class TestPointSourceRendering(object):
    ...
    def test_point_source_rendering_unconvolved_for_interferometry(self):
        ...
        model_ref = self._ps_rendering_ref.point_source_rendering_unconvolved_for_interferometry(
            ra_pos, dec_pos, amp
        )
        npt.assert_allclose(model, model_ref, atol=1e-8, rtol=1e-8)
...
class TestPointSourceRenderingSuperSampling(TestPointSourceRendering):
    ...
    def test_point_source_rendering_unconvolved_for_interferometry(self):
        ...
        npt.assert_raises(
            ValueError,
            super().test_point_source_rendering_unconvolved_for_interferometry,
        )
